...
const Nav: React.FC<NavProps> = () => {
    ...
    const showMore = (event: React.MouseEvent<HTMLAnchorElement>): void => {
        const span = event.currentTarget.querySelector("span") as HTMLSpanElement

        const svg = event.currentTarget.querySelector(".svg-theme-change") as HTMLDivElement
        const child = svg.firstChild as SVGElement
        ...
        if(span.textContent === "Show more") {
            ...
            if(navDivRef?.current) {
                navDivRef.current.querySelectorAll<HTMLAnchorElement>(".can-hide").forEach((value: HTMLAnchorElement) => {
    ...
    return (
        <nav>
            <div ref={navDivRef} className="nav-division">
                <NavItem href="/" name="Home" id="home-nav">
                    {
                        pathname === "/" ?
                ...
                <div className="nav-sub-division-line"></div>
                <NavItem name="">
                    <span style={{ fontSize: "1rem", lineHeight: "22px", paddingRight: "8px" }}><strong>You</strong></span>
            ...
            <div id="guide-links">
                <div className="guide-link-division">
                    <a href="#">About</a>
                    <a href="#">Press</a>
                    <a href="#">Copyright</a>
                    <a href="#">Contact us</a>
            ...
            <div id="mini-nav">
                <a href="/" className="mini-nav-item low-hover-lighter">
                    {
                        pathname === "/" ?
                            <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                                <g>
