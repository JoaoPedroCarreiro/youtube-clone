...
const Nav: React.FC<NavProps> = () => {
    ...
    const showMore = (event: React.MouseEvent<HTMLButtonElement>): void => {
        ...
        if(span.textContent === "Show more") {
            ...
            if(navDivRef?.current) {
                navDivRef.current.querySelectorAll<HTMLButtonElement>(".can-hide").forEach((value: HTMLButtonElement) => {
    ...
    return (
        <nav>
            ...
            <div id="mini-nav">
                <button className="mini-nav-item low-hover-lighter">
                    <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
                        <g>
                            <path d="M4 21V10.08l8-6.96 8 6.96V21h-6v-6h-4v6H4z"></path>
                        </g>
